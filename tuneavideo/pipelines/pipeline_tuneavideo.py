    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.check_inputs(prompt, 
                          height, 
                          #gligen_boxes, #To-Do : implement this
                          width, 
                          callback_steps)
        ...
        if gligen:
            ...
            # print("tokenizer_inputs : ", tokenizer_inputs) #토크나이저 잘되는지 확인
            # BOS(49406) 토큰을 넣고, 뒤에는 EOS(49407) 토큰 => ["a birthday cake"] converted to 
            _text_embeddings = self.text_encoder(**tokenizer_inputs).pooler_output
            # print("text_embeddings : ",_text_embeddings) #텍스트 임베딩 잘떨어지는지 확인
            ...
            repeat_batch = batch_size * num_videos_per_prompt
